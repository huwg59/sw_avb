...
In addition the following kit can be used for development:
  ...
  * `SliceKIT Core Board <http://www.xmos.com/products/xkits/slicekit#slicekit-core-board>`_ with 1 x Ethernet slice and 1 x Audio slice fitted with CS2100-CP PLL. 
